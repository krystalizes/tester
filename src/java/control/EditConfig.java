...
@WebServlet(name = "EditConfig", urlPatterns = {"/EditConfig"})
public class EditConfig extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (a == null){
            ...
            String mocdien=request.getParameter("txt2");
            String gia=request.getParameter("txt3");        
            DAO dao=new DAO();
            dao.suaConfig(mocdien, gia, id);
            request.getRequestDispatcher("Configure").forward(request, response);
        }
