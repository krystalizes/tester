...
public class EditCustomer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (a == null){
            ...
            String maKH=request.getParameter("txt1");
            String ten=request.getParameter("txt2");
            String sdt=request.getParameter("txt3"); 
            String dchi=request.getParameter("txt4");    
            String email=request.getParameter("txt5");    
            DAO dao=new DAO();
            dao.suaCustomer(ten, sdt, dchi, email, maKH);
            response.sendRedirect(request.getContextPath() + "/LoadDanhsachCus");
        }
    }
